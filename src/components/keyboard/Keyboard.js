...
export default class Keyboard {
  constructor(root) {
    ...
    this.keysData = [
      ...
      new SetStateKey(this.root, 'ShiftLeft', 'Shift', this.root.setIsShiftPressed, false, 100), new Key(this.root, 'KeyZ', 'z', 'Z', 'я', 'Я'), new Key(this.root, 'KeyX', 'x', 'X', 'ч', 'Ч'), new Key(this.root, 'KeyC', 'c', 'C', 'с', 'С'), new Key(this.root, 'KeyV', 'v', 'V', 'м', 'М'), new Key(this.root, 'KeyB', 'b', 'B', 'и', 'И'), new Key(this.root, 'KeyN', 'n', 'N', 'т', 'Т'), new Key(this.root, 'KeyM', 'm', 'M', 'ь', 'Ь'), new Key(this.root, 'Comma', ',', '<', 'б', 'Б'), new Key(this.root, 'Period', '.', '>', 'ю', 'Ю'), new Key(this.root, 'Slash', '/', '?', '.', ','), new SimpleKey(this.root, 'ArrowUp', '▲', '▲'), new SetStateKey(this.root, 'ShiftRight', 'Shift', this.root.setIsShiftPressed, false, 86),
      new FuncKey(this.root, 'ControlLeft', 'Ctrl'), new FuncKey(this.root, 'MetaLeft', 'Win'), new FuncKey(this.root, 'AltLeft', 'Alt'), new SimpleKey(this.root, 'Space', '', ' ', 330), new FuncKey(this.root, 'AltRight', 'Alt'), new SimpleKey(this.root, 'ArrowLeft', '◄', '◄'), new SimpleKey(this.root, 'ArrowDown', '▼', '▼'), new SimpleKey(this.root, 'ArrowRight', '►', '►'), new FuncKey(this.root, 'ControlRight', 'Ctrl'),
    ];
