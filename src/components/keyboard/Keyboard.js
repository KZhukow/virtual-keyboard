...
export default class Keyboard {
  constructor(root) {
    ...
    this.keysData = [
      ...
      new SimpleKey(this.root, 'Tab', 'Tab', '\t', 50), new Key(this.root, 'KeyQ', 'q', 'Q', 'й', 'Й'), new Key(this.root, 'KeyW', 'w', 'W', 'ц', 'Ц'), new Key(this.root, 'KeyE', 'e', 'E', 'у', 'У'), new Key(this.root, 'KeyR', 'r', 'R', 'к', 'К'), new Key(this.root, 'KeyT', 't', 'T', 'е', 'Е'), new Key(this.root, 'KeyY', 'y', 'Y', 'н', 'Н'), new Key(this.root, 'KeyU', 'u', 'U', 'г', 'Г'), new Key(this.root, 'KeyI', 'i', 'I', 'ш', 'Ш'), new Key(this.root, 'KeyO', 'o', 'O', 'щ', 'Щ'), new Key(this.root, 'KeyP', 'p', 'P', 'з', 'З'), new Key(this.root, 'BracketLeft', '[', '{', 'х', 'Х'), new Key(this.root, 'BracketRight', ']', '}', 'ъ', 'Ъ'), new Key(this.root, 'Backslash', '\\', '|', '\\', '/'), new FuncKey(this.root, 'Delete', 'Del', [this.root.changeInputState.bind(this.root, this.root.delNextSymbol)], null, 44),
    ];
